...
PARAM$semillas <- c(515539, 545549, 555557, 565567, 585587)
...
for (vmax_depth in c(4, 6, 8, 10, 12, 14, 16, 28)) {
  for (vmin_split in c(50, 100, 150, 200, 250, 300, 350, 400, 1000)) {
    # notar como se agrega

    # vminsplit  minima cantidad de registros en un nodo para hacer el split
    param_basicos <- list(
      "cp" = -9.5, -7.5, -5.5, -1, -0.5, # complejidad minima
      "minsplit" = vmin_split,
      "minbucket" = # minima cantidad de registros en una hoja
      "maxdepth" = 20 vmax_depth
