...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_002", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_002", "DT0001_002" )

  DR_drifting_guantesblancos( "DR0001_002", "CA0001_002" )
  FE_historia_guantesblancos( "FE0001_002", "DR0001_002" )

  TS_strategy_guantesblancos_202109( "TS0001_002", "FE0001_002" )

  HT_tuning_guantesblancos( "HT0001_002", "TS0001_002" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_002", c("HT0001_002","TS0001_002") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_002", "FE0001_002" )

  HT_tuning_guantesblancos( "HT0002_002", "TS0002_002" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002", c("HT0002_002", "TS0002_002") )
...
corrida_guantesblancos_202109( "gb01_002" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_002" )
