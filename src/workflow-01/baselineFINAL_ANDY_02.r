...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BR02", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BR02", "DT0001_BR02" )
  
  DR_drifting_guantesblancos( "DR0001_BR02", "CA0001_BR02" )
  FE_historia_guantesblancos( "FE0001_BR02", "DR0001_BR02" )
  
  TS_strategy_guantesblancos_202109( "TS0001_BR02", "FE0001_BR02" )
  
  HT_tuning_guantesblancos( "HT0001_BR02", "TS0001_BR02" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BR02", c("HT0001_BR02","TS0001_BR02") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BR02", "FE0001_BR02" )
  
  HT_tuning_guantesblancos( "HT0002_BR02", "TS0002_BR02" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BR02", c("HT0002_BR02", "TS0002_BR02") )
...
corrida_guantesblancos_202107( "gb02_1_BR02" )
