...
# pmyexp <- "CA0001_BaselineR05"
# pinputexps <- "DT0002_BaselineR05"
# pserver <- "local"
...
# pmyexp <- "DR0001_BaselineR05"
# pinputexps <- "CA0001_BaselineR05"
# pserver <- "local"
...
# pmyexp <- "FE0001_BaselineR05"
# pinputexps <- "DR0001_BaselineR05"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BaselineR05", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BaselineR05", "DT0001_BaselineR05" )
  
  DR_drifting_guantesblancos( "DR0001_BaselineR05", "CA0001_BaselineR05" )
  FE_historia_guantesblancos( "FE0001_BaselineR05", "DR0001_BaselineR05" )
  
  TS_strategy_guantesblancos_202109( "TS0001_BaselineR05", "FE0001_BaselineR05" )
  
  HT_tuning_guantesblancos( "HT0001_BaselineR05", "TS0001_BaselineR05" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BaselineR05", c("HT0001_BaselineR05","TS0001_BaselineR05") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BaselineR05", "FE0001_BaselineR05" )
  
  HT_tuning_guantesblancos( "HT0002_BaselineR05", "TS0002_BaselineR05" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BaselineR05", c("HT0002_BaselineR05", "TS0002_BaselineR05") )
...
#corrida_guantesblancos_202109( "gb01_BaselineR05" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BaselineR05" )