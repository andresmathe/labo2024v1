...
# pmyexp <- "CA0001_BaselineR1"
# pinputexps <- "DT0002_BaselineR1"
# pserver <- "local"
...
# pmyexp <- "DR0001_BaselineR1"
# pinputexps <- "CA0001_BaselineR1"
# pserver <- "local"
...
# pmyexp <- "FE0001_BaselineR1"
# pinputexps <- "DR0001_BaselineR1"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BaselineR1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BaselineR1", "DT0001_BaselineR1" )
  
  DR_drifting_guantesblancos( "DR0001_BaselineR1", "CA0001_BaselineR1" )
  FE_historia_guantesblancos( "FE0001_BaselineR1", "DR0001_BaselineR1" )
  
  TS_strategy_guantesblancos_202109( "TS0001_BaselineR1", "FE0001_BaselineR1" )
  
  HT_tuning_guantesblancos( "HT0001_BaselineR1", "TS0001_BaselineR1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BaselineR1", c("HT0001_BaselineR1","TS0001_BaselineR1") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BaselineR1", "FE0001_BaselineR1" )
  
  HT_tuning_guantesblancos( "HT0002_BaselineR1", "TS0002_BaselineR1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BaselineR1", c("HT0002_BaselineR1", "TS0002_BaselineR1") )
...
corrida_guantesblancos_202107( "gb02_BaselineR1" )